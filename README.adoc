...
I think nowadays the plugin is named 'Confluent' and support also other downloads like TSV, CSV and JSON.

We might support that too, but on the other hand that then is hardly necessary.
